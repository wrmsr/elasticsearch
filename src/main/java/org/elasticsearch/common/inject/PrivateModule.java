...
public abstract class PrivateModule implements Module {
  ...
  /*if[AOP]*/
  /**
   * @see Binder#bindInterceptor(org.elasticsearch.common.inject.matcher.Matcher, org.elasticsearch.common.inject.matcher.Matcher, org.aopalliance.intercept.MethodInterceptor[])
   */
